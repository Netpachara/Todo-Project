...
//    @Query("FROM User_Role u WHERE u.userRoleID.userID =:userID AND u.userRoleID.roleID =:roleID")
//    User_Role findByUserIDAndRole(@Param("userID") Integer userID, @Param("roleID") Integer roleID);
